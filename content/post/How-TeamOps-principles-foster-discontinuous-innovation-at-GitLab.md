...
* Valuing [Results transparently](https://about.gitlab.com/handbook/teamops/measurement-clarity/)
* Creating a [Shared Reality](https://about.gitlab.com/handbook/teamops/shared-reality/)
* Enabling [Everyone to Contribute](https://about.gitlab.com/handbook/teamops/everyone-contributes/)
* Maximizing [Decision Velocity](https://about.gitlab.com/handbook/teamops/decision-velocity/)

These principles are supported by a set of action tenets that provide guidance on how to put them into practice.

TeamOps emphasizes the importance of transparency, flexibility, and empowerment in order to create a more efficient, productive, and satisfying work environment. It is based on the belief that everyone should have the [opportunity to contribute](https://about.gitlab.com/handbook/teamops/everyone-contributes/) and that organizations should focus on [measuring results](https://about.gitlab.com/handbook/teamops/measurement-clarity/) rather than inputs such as hours worked.
...
It often involves the development of a new technology or [business model](https://en.wikipedia.org/wiki/Business_model) that disrupts the existing market, making it difficult for incumbent firms to compete.

Discontinuous innovation can be difficult to predict and risky for organizations to pursue, as it often involves significant changes to existing [business models](https://en.wikipedia.org/wiki/Business_model) and technologies.
...
All Decisions focused to the [smallest scope](https://about.gitlab.com/handbook/values/#move-fast-by-shipping-the-minimal-viable-change) on the [lowest level](https://about.gitlab.com/handbook/teamops/decision-velocity/#push-decisions-to-the-lowest-possible-level) stepping through [evolutionary iterations](https://about.gitlab.com/handbook/values/#iteration) driven by a designated [Directly Responsible Individuals (DRI)](https://about.gitlab.com/handbook/people-group/directly-responsible-individuals/), lead to the fittest solution surviving as a [Minimal Viable Change (MVC)](https://about.gitlab.com/handbook/product/product-principles/#the-minimal-viable-change-mvc).
...
To stay ahead of the curve and be competitive in the market, your organization needs also to continuously look for [new and innovative ways](https://about.gitlab.com/direction/) to solve problems and create value.
...
In 2016 [Kamil Trzciński](https://about.gitlab.com/handbook/engineering/readmes/kamil-trzcinski/), at the time a fresh full member of the GitLab team, approached GitLab’s co founder [Dimitri Zaporozhets](https://dzaporozhets.gitlab.io/) with the idea to fuse [GitLab Source Code Management (SCM)](https://about.gitlab.com/stages-devops-lifecycle/source-code-management/) and [Continuous Integration (CI)](https://about.gitlab.com/features/continuous-integration/) into one DevOps Tool and was many times rejected.

The tools should stay lean and simple. A fusion would build a complicated [Monolith](https://en.wikipedia.org/wiki/Monolithic_application).

While committing to this decision and contributing to the source code of both tools, Kamil ideated a common tool with all the synergies and advantages one all encompassing DevOps Platform has for the [Software Development Life Cycle (SDLC)](https://en.wikipedia.org/wiki/Software_development_process).

At the end Dimitri and his other co-founder, [Sid Sijbrandij](https://gitlab.com/sytses), [saw the value in the direction Kamil had proposed](https://www.youtube.com/watch?v=4BIsON95fl8&t=2034s). You can [listen to the story told by himself here](https://youtu.be/CiJOTlU3wWs?t=222).
...
In this division, [Single-engineer Groups](https://about.gitlab.com/company/team/structure/#single-engineer-groups) move fast, ship, get feedback, and iterate on specific ideas to draw benefits, but not distractions, from within the larger organization.

The established [Software Demo Process](https://about.gitlab.com/handbook/engineering/#engineering-demo-process) facilitates asynchronous collaboration, iterative feedback, and minimal alignment with the rest of GitLab while keeping the autonomy of this incubator.
...
First, the principle of [enabling everyone to contribute](https://about.gitlab.com/handbook/teamops/everyone-contributes/) encourages a diverse range of perspectives and ideas, which can be essential for generating new and innovative solutions. By providing equal opportunities for all team members to contribute, regardless of level, function, or location, organizations can create an environment that is more conducive to innovative thinking.

Second, the principle of [maximizing decision velocity](https://about.gitlab.com/handbook/teamops/decision-velocity/) helps organizations act quickly on new ideas, rather than getting bogged down in lengthy decision-making processes. This can be especially important in the fast-moving software industry, where time is of the essence.

Third, the sub value of “[Disagree, commit, and disagree](https://about.gitlab.com/handbook/values/#disagree-commit-and-disagree)” facilitates team members to ideate and propose better solutions for decisions taken in the past. This empowers everyone to come up with a disruptive innovation to a problem, which was not solved in the best way.

Finally, the principle of [transparent measurement](https://about.gitlab.com/handbook/teamops/measurement-clarity/) helps organizations focus on results rather than inputs, which can encourage a focus on innovation rather than simply meeting short-term targets. By measuring and rewarding results rather than the number of hours worked or other inputs, organizations can create an environment that encourages team members to take risks and try new things.

At GitLab, these principles are supported by a number of action tenets, including [asynchronous workflows](https://about.gitlab.com/company/culture/all-remote/asynchronous/), which allow team members to collaborate and contribute on their own time, and [Directly Responsible Individuals (DRIs)](https://about.gitlab.com/handbook/people-group/directly-responsible-individuals/#what-is-a-directly-responsible-individual), who are empowered to make decisions and take ownership of projects.
